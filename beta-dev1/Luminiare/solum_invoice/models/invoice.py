...
class InvoiceExtension(models.Model):
    ...
    @api.model
    def get_designer(self,incharge_ids):
        incharge = ''
        for incharge_id in incharge_ids:
    ...
    remarks_ids = fields.One2many('invoice.remarks','invoice_id','Remarks',copy=True)
    ...
    inchange_ids = fields.Many2many('res.partner', 'invoice_partner_rel', 'invoice_id', 'partner_id', string='Designer Incharge', copy=True)
    ...
    def _onchange_partner_id(self):
        ...
        if self.partner_id.child_ids:
            ...
            self.inchange_ids = [(6, 0, child_list)]
        else:
            self.inchange_ids = [(6, 0, child_list)]
