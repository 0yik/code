...
class department_total_payroll_report(models.AbstractModel):
    _name = 'report.teo_payroll.dpt_total_payroll_report_temp'
    ...
    def render_html(self, docids, data):
        ...
        return self.env['report'].render('teo_payroll.dpt_total_payroll_report_temp', docargs)
