...
class cmp_total_payroll_wizard(models.TransientModel):

    _name = 'cmp.total.payroll.wizard'
    ...
    def print_report(self):
        ...
        return self.env['report'].get_action(self, 'teo_payroll.company_total_payroll_report_tmp' , data = datas)
