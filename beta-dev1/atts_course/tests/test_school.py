...
class TestSchool(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.school_id = self.env.ref('atts_course.demo_school_1')
        self.standard_medium = self.env.ref('atts_course.demo_standard_medium_1')
        self.year = self.env.ref('atts_course.demo_academic_year_2')
        self.currency_id = self.env.ref('base.INR')
        self.sch = self.env.ref('atts_course.demo_school_1')
        self.country_id = self.env.ref('base.in')
        self.std = self.env.ref('atts_course.demo_standard_standard_1')
