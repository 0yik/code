odoo.define('pos_scan_SN.main', function (require) {
"use strict";
    ...
    models.PosModel = models.PosModel.extend({
        scan_product: function(parsed_code){
            if (parsed_code.type === 'product'){
                ...
                var product_id = this.serial_by_name[parsed_code.base_code] ? this.serial_by_name[parsed_code.base_code].product_id[0] : false;
