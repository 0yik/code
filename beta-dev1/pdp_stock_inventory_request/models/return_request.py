...
class ReturnRequestLine(models.Model):
    ...
    #         self.stock_display_gudang = self.env['stock.warehouse.orderpoint'].search([('product_id', '=', self.product_id.id), ('warehouse_id', '=', self.location_id.id)], limit=1,order='id desc').product_min_qty or 0
