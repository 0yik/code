        ...
        $.getJSON("/pos/mirror_data", function(result){
            ...
            if(result['name'] !='[]'){
                ...
                for(var i=0;i<obj.length-1;i++){                                                                                                                     
                    product_data+="<tr><td class='product_name'><b>"+obj[i][0]+"</b><br/><span class='product_price'>"+obj[i][2]+" "+obj[i][3]+" at "+symbol+" "+obj[i][1].toFixed(2)+"/"+obj[i][3]+"</span>";               
                    if(obj[i][4] != 0){
                    product_data+="<br/><span class='product_price'>With a "+obj[i][4]+"% discount</span></td>";
                    }
                    product_data+="<td class='product_name1'><b>"+symbol+" "+((obj[i][1]*obj[i][2])-(obj[i][2]*(obj[i][1]*obj[i][4]*.01))).toFixed(2)+"</b></td></tr>";  
                }
                if(obj.length <= 1){
                    $(".total_amount").html("");
                    $(".total_tax").html("");
                    ...
                    $(".total_amount").html("Total: "+symbol+" "+obj[obj.length-1][1].toFixed(2));
                    $(".total_tax").html("GST: "+symbol+" "+obj[obj.length-1][0].toFixed(2));
                }
            ...
            if(result['payment_line'] !='[]'){
                ...
                var payment_data ="";
                for(var i=0;i<obj.length-1;i++){ 
                    payment_data+="<tr><td class='payment_name' style='color:#555555;'><b>"+obj[i][0]+"</b><span class='product_name1'>"+symbol+" "+obj[i][1].toFixed(2)+"</span></td></tr>";     
                }
                ...
                if(obj.length <= 0){
                    ...
                    if(obj[obj.length-1][0]!= undefined)
                        payment_data+="<tr><td class='payment_amount'><b>Paid</b><span class='product_name1'>"+symbol+" "+obj[obj.length-1][0].toFixed(2)+"</span></td></tr>";
                    if(obj[obj.length-1][1]!= undefined)
                        payment_data+="<tr><td class='payment_amount'><b>Remaining</b><span class='product_name1'>"+symbol+" "+obj[obj.length-1][1].toFixed(2)+"</span></td></tr>";
                    if(obj[obj.length-1][2]!= undefined)
                        payment_data+="<tr><td class='payment_amount'><b>Change</b><span class='product_name1'>"+symbol+" "+obj[obj.length-1][2].toFixed(2)+"</span></td></tr>";
                    if(obj[obj.length-1][4]!= undefined)
                        payment_data+="<tr><td class='payment_amount'><b>Coupon Amount</b><span class='product_name1'>"+symbol+" "+obj[obj.length-1][4].toFixed(2)+"</span></td></tr>";
                    if(obj[obj.length-1][3]!= undefined)
                        payment_data+="<tr><td class='payment_amount'><b>Redeem Amount</b><span class='product_name1'>"+symbol+" "+obj[obj.length-1][3].toFixed(2)+"</span></td></tr>";
