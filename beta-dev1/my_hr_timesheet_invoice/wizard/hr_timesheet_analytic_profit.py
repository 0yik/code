...
class account_analytic_profit(models.TransientModel):
    ...
    employee_ids = fields.Many2many('res.users', 'analytic_profit_emp_rel', 'analytic_id', 'emp_id', 'User',
                                    required=True)
    ...
    def print_report(self):
        ...
        if not ids_chk:
            raise exceptions.Warning(_('Insufficient Data!'), _('No record(s) found for this report.'))
