...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def render_html(self, docids, data=None):
        ...
        currency_id = docs.currency_id if docs.currency_id else self.env.user.company_id.currency_id
        ...
        movelines, total, dummy = self._get_partner_move_lines(account_type, date_from, target_move, data['form']['period_length'], currency_id)
        docargs = {
            'doc_ids': self.ids,
            'doc_model': model,
            'data': data['form'],
