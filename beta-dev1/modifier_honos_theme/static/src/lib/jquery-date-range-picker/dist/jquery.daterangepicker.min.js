    ...
    e.dateRangePickerLanguages = {
        ...
        function n() {
            if (!a.inline) {
                ...
                if ("relative" == e(a.container).css("position")) {
                    ...
                    J.css({
                        top: t.top - n.top + e(U).outerHeight() + 4,
        ...
        function c(n) {
            if (!n.hasClass("invalid")) {
                ...
                a.start = parseInt(a.start), a.end = parseInt(a.end), g(), a.start && !a.end && (e(U).trigger("datepicker-first-date-selected", {
        ...
        function v(t) {
            ...
            if (t.hasClass("has-tooltip") && t.attr("data-tooltip")) r = '<span class="tooltip-content">' + t.attr("data-tooltip") + "</span>";
                ...
                if (a.singleDate) J.find(".day.hovering").removeClass("hovering"), t.addClass("hovering");
        ...
        function Y() {
            if (!a.alwaysOpen) {
                var t = function() {
                    e(U).data("date-picker-opened", !1), e(U).trigger("datepicker-closed", {
                        relatedTarget: J
                    })
                };
                a.customCloseAnimation ? a.customCloseAnimation.call(J.get(0), t) : e(J).slideUp(a.duration, t), e(U).trigger("datepicker-close", {
                    relatedTarget: J
                })
            }
        }
        ...
        return e(this).unbind(".datepicker").bind("click.datepicker", function(e) {
            ...
            function() {
                var r = this;
                if (e(this).data("date-picker-opened")) Y();
                else {
                    ...
                    var s = q();
                    if ($(s), a.time.enabled)
                        if (a.startDate && a.endDate || a.start && a.end) j(t(a.start || a.startDate).toDate(), "time1"), j(t(a.end || a.endDate).toDate(), "time2");
                        else {
                    ...
                    d = a.singleDate ? E("default-single") : a.minDays && a.maxDays ? E("default-range") : a.minDays ? E("default-more") : a.maxDays ? E("default-less") : E("default-default"), J.find(".default-top").html(d.replace(/\%d/, a.minDays).replace(/\%d/, a.maxDays)), a.singleMonth ? J.addClass("single-month") : J.addClass("two-months"), setTimeout(function() {
                        ...
                        } else if (-1 != n.indexOf("month"))(s = 1 == (t = -1 != n.indexOf("prev,") ? -1 : 1) ? N(r) : B(r)).setDate(1), (r = N(s)).setDate(1), r = new Date(r.getTime() - 864e5);
