...
class report_account_followup_report(models.AbstractModel):
    ...
    def get_template(self):
        return 'enterprise_accounting_report.report_followup'
...
class account_report_context_followup_all(models.TransientModel):
    ...
    def get_html(self, given_context=None):
        ...
        res = self.env['ir.model.data'].xmlid_to_object('enterprise_accounting_report.report_followup_all').render(rcontext)
...
class account_report_context_followup(models.TransientModel):
    ...
    def change_next_action(self, date, note):
        ...
        if self.partner_id.payment_next_action_date != fields.Date.context_today(self):
            ...
            msg = note
        self.partner_id.message_post(body=msg, subtype='enterprise_accounting_report.followup_logged_action')
    ...
    def get_pdf(self, log=False):
        ...
        for context in self:
            ...
            if log:
                ...
                context.partner_id.message_post(body=msg, subtype='enterprise_accounting_report.followup_logged_action')
    ...
    def get_history(self):
        return self.env['mail.message'].search([('subtype_id', '=', self.env.ref('enterprise_accounting_report.followup_logged_action').id), ('id', 'in', self.partner_id.message_ids.ids)], limit=5)
    ...
    def get_html(self, given_context=None):
        ...
        return self.env['ir.model.data'].xmlid_to_object('enterprise_accounting_report.report_followup').render(rcontext)
