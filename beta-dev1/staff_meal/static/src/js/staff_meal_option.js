odoo.define('staff_mean.staff_meal_option', function (require) {
"use strict";
    ...
    var StaffMeanOptionsPopupWidget = PopupWidget.extend({
        ...
        staff_mean_order_click : function () {
            ...
            if(this.pos.all_free){
                ...
                $('.order-submit').addClass('oe_hidden');
            }
            else{

                $('.CreateSalesOrderbutton').removeClass('oe_hidden');
                $('.order-submit').removeClass('oe_hidden');
            }
    ...
    screens.ProductScreenWidget.include({
		...
		show: function(){
            ...
            }else if(this.pos.category == "dive_in"){
