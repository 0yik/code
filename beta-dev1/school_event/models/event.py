...
class SchoolEvent(models.Model):
	...
	def _search(self, args, offset=0, limit=None, order=None, count=False,access_rights_uid=None):
		if self._context.get('part_name_id'):
			...
			if data and data.standard_id:
				arg_domain = ('part_standard_ids', 'in', [data.standard_id.id])
				args.append(arg_domain)
		return super(SchoolEvent, self)._search(args=args, offset=offset,limit=limit, count=count,access_rights_uid=access_rights_uid)
...
class StudentStudent(models.Model):
	...
	def _search(self, args, offset=0, limit=None, order=None, count=False, access_rights_uid=None):
		...
		return super(StudentStudent, self)._search(args=args, offset=offset, limit=limit, order=order, count=count, access_rights_uid=access_rights_uid)
