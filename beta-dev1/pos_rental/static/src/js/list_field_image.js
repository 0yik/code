odoo.define('pos_rental.list_image', function (require) {
    "use strict";
    ...
    var FieldBinaryImage = list_widget_registry.get('field.binary').extend({
    ...
    list_widget_registry.add('field.image', FieldBinaryImage);
});
