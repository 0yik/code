...
class PurchaseMaterialRequest(models.Model):
    ...
    requested_by = fields.Many2one('product.brand', 'Requested by', required=True, track_visibility='onchange')
...
class PurchaseMaterialRequestLine(models.Model):
    ...
    requested_by = fields.Many2one('product.brand', related='request_id.requested_by', string='Requested by', store=True,
                                   readonly=True)
