odoo.define('sarangoci_sales_website.cart_sale', function (require) {
//     "use strict";
...
odoo.define('sarangoci_sales_website.sarangoci_sales_website', function (require) {
    "use strict";
        ...
        $(oe_website_sale).on("change", ".oe_cart input.js_quantity[data-product-id]", function () {
          ...
          clickwatch(function(){
            ...
            ajax.jsonRpc("/sale/cart/update_json", 'call', {
                ...
                $(".js_cart_lines").first().before(data['sarangoci_sales_website.cart_lines']).end().remove();
