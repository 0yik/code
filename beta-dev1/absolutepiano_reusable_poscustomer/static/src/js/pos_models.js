...
exports.PosModel = Backbone.Model.extend({
    ...
    models: [
    {
        ...
        model:  'res.partner',
        fields: ['name', 'street', 'city', 'state_id', 'country_id', 'vat', 'phone', 'zip', 'mobile', 'email', 'barcode', 'write_date', 'property_account_position_id', 'use_delivery_addr', 'country_code', 'company_mobile', 'unit_no', 'd_unit_no', 'd_street', 'd_city', 'd_zip', 'd_country_id'],
        ...
        model:  'partner.country.code',
        fields: ['name'],
        loaded: function(self,countries_code){
