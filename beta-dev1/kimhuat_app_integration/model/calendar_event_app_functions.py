...
class calendar_event(models.Model):
    ...
    def get_calendar_data_app(self,partner_id):
        ...
        for cal_obj in calendar_events:
            ...
            address = cal_obj.work_order_id.get_work_order_address(cal_obj.work_order_id)
            vals['starting_at'] = cal_obj.start_datetime
            vals['duration'] = cal_obj.duration
            vals['location'] = cal_obj.location if cal_obj.location else address
            ...
            if cal_obj.work_order_id.state == 'pending':
                state = 'Pending'
            elif cal_obj.work_order_id.state == 'started':
                state = 'Started'
