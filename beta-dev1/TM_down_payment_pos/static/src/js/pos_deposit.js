odoo.define('TM_down_payment_pos.pos_deposit', function (require) {
"use strict";
    ...
    var ListCustomerDepositScreen = screens.ScreenWidget.extend({
        ...
        show: function () {
            ...
            var filter = [['is_deposit', '=', true],['remaining_amount','!=',0],['payment_type','=','inbound'],['partner_type','=','customer'],['state','=','posted']];
            var client = this.pos.get_order().get_client();
            if(client){
                filter.push(['partner_id','=',client.id]);
            }
