...
class TestFees(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.student = self.env.ref('atts_course.demo_student_student_5')
        self.school = self.env.ref('atts_course.demo_school_1')
        self.standard = self.env.ref('atts_course.demo_school_standard_1')
