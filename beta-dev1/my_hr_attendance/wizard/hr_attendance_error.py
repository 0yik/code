...
class hr_attendance_error(models.TransientModel):
    ...
    def print_report(self):
        ...
        if not attendance_ids:
            raise exceptions.WarningModel(_('No Data Available!'), _('No records are found for your selection!'))
        ...
        return self.env['report'].get_action('hr_attendance.report_attendanceerrors', data=datas)
