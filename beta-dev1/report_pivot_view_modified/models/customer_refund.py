...
#             'residual', 'state', 'type', 'user_id', 'number', 'amount_total', 'comment'
#         ],
...
#                     sub.weight, sub.volume, sub.number, sub.amount_total, sub.comment
...
#                         u2.name AS uom_name,
#                         ai.currency_id, ai.journal_id, ai.fiscal_position_id, ai.user_id, ai.company_id, ai.number, ai.
#                         1 AS nbr,
...
#                         ai.amount_total_company_signed, ai.commercial_partner_id, partner.country_id ,ai.number, ai.amount_total
#                         ai.comment,
#             """
#         return group_by_str
#
