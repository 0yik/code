...
#                                        prv_yr_gross_amt += line.amount
    ...
    #                                    salary_amt += line.amount
                            ...
                            if emp.employee_income_tax in ['H']:
                                tot_employee_income += int('%0*d' % (9, int(abs(emp.employee_income))))
...
#                                    (int(emp.entertainment_allowance) or 0) + (int(other_allowance) or 0) + (int(emp.gratuity_payment_amt) or 0) + \
