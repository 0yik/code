...
class honosCompare(http.Controller):   
    ...
    def cproduct(self, **kwargs):
        ...
        return request.render("honos_compare.honos_compare_page_template", products)
    ...
    def comparepopout(self,page=0, category=None, search='', **kwargs):   
        ...
        response = http.Response(template="honos_compare.honos_compare_popover_data",qcontext=products)                        
