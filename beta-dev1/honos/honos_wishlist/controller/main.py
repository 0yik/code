...
class honosWishlist(http.Controller):   
    ...
    def wishproduct(self,page=0, category=None, search='', **kwargs):
        ...
        return request.render("honos_wishlist.honos_wishlist_wishlist_template",products)
    ...
    def wishpopout(self,page=0, category=None, search='', **kwargs):
            ...
            response = http.Response(template="honos_wishlist.honos_wishlist_popover_data",qcontext=products)            
    ...
    def wishalert(self,last_product_id=False,**kwargs):
        ...
        return request.env.ref("honos_wishlist.honos_wishlist_wishlist_product").render(values)
