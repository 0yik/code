odoo.define('pos_order_branch.pos', function (require) {
    ...
    models.Order = models.Order.extend({
        get_total_without_tax: function() {
            ...
            return round_pr(this.orderlines.reduce((function(sum, orderLine) {
                var amount = orderLine.get_price_without_tax();
                return sum + amount;
    ...
    screens.OrderWidget.include({
        update_summary: function(){
            ...
            this.el.querySelector('.summary .total .sub-total .value').textContent = this.format_currency(parseFloat(sub_total_ext));
            this.el.querySelector('.summary .total .total-total .value').textContent = this.format_currency(total);
