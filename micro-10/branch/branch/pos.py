...
class pos_session(models.Model):
    ...
    branch_id = fields.Many2one('res.branch', 'Branch', default = _get_session_default_branch)    
...
class pos_order(models.Model):
    ...
    branch_id = fields.Many2one('res.branch', 'Branch', default = _get_pos_order_default_branch)
