odoo.define('enterprise_accounting_report.account_report_followup_generic', function (require) {
'use strict';

var core = require('web.core');
var Model = require('web.Model');
var Pager = require('web.Pager');
var FollowupReportWidget = require('enterprise_accounting_report.FollowupReportWidget');
var account_report_generic = require('enterprise_accounting_report.account_report_generic');
...
var account_report_followup_generic = account_report_generic.extend({
    ...
    render_searchview_buttons: function() {
        ...
        if (this.followup_all) {
            ...
            this.$partnerFilter = this.$searchview_buttons.siblings('.o_enterprise_accounting_report_date-filter');
