odoo.define('pos_note_category_onproduct', function (require) {
	...
	var NewOrderlineNoteButton = require('NewOrderlineNoteButton');
	...
	models.Orderline = models.Orderline.extend({
	    ...
	    export_as_JSON: function(){
	        ...
	        json.displaynote = this.displaynote;
	    },
	    init_from_JSON: function(json){
	        _super_orderline.init_from_JSON.apply(this,arguments);
	        this.displaynote = json.displaynote;
	    },
	...
	var NewOrderlineNoteButton = NewOrderlineNoteButton.extend({
		template: 'NewOrderlineNoteButton',
	    button_click: function(){
	    	console.log("butonnnnnnnnnn");
	        var self = this;
