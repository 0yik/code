                ...
                for contract in contract_ids:
                    ...
                    if contract_income_tax_ids and contract_income_tax_ids.ids:
                        for emp in contract_income_tax_ids[0]:
                            ...
                            annual_value = '%0*d' % (9, int(abs(emp.annual_value)))
...
#                            else:
                            ...
                            place_of_residence_taxable_value = '%0*d' % (9, int(abs(emp.place_of_residence_taxable_value)))
                            total_rent_paid = '%0*d' % (9, int(abs(emp.total_rent_paid)))
                            ...
                            detail_record = '1'.ljust(1) + \
                                            ...
                                            tools.ustr(annual_value)[:9].ljust(9) +\
