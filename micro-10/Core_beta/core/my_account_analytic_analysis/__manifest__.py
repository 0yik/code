...
""",
    ...
    'depends': ['my_hr_timesheet_invoice','project', 'sale'], #although sale is technically not required to install this module, all menuitems are located under 'Sales' application
    'data': [
