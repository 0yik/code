...
class wizard_1721_3a1_report(models.TransientModel):
    _name = 'wizard.1721.3a1.report'
    ...
    def print_report(self):
        ...
        return self.env['report'].get_action(self, 'indonesia_spt.report_1721_3a1',data=datas)
