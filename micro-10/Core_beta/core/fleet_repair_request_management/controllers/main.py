...
#                                                     'company_name':request.env.user.company_id.name
    ...
    def feedback_email(self, order_id, **kw):
        ...
        return request.render("website.repair_feedback", values) 
...
class website_account(website_account):
    ...
    def my_repiar(self, repair=None, **kw):
        ...
        return request.render("fleet_repair_request_management.display_fleet_repairs", {'repair': repair, 'user': request.env.user})
