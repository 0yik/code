    ...
    def _check_date(self):
        ...
        for holiday in self:
            ...
            if holiday.date_to and holiday.date_from:
                year_to = datetime.datetime.strptime(holiday.date_to, DEFAULT_SERVER_DATETIME_FORMAT).year
                year_from = datetime.datetime.strptime(holiday.date_from, DEFAULT_SERVER_DATETIME_FORMAT).year
