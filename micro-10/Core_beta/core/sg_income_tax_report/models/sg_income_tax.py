...
#---------------------------------------------------#
    ...
    from_ir8s = fields.Selection(selection=[('Y', 'IR8S is applicable'), 
                                            ('N', 'IR8S is not applicable')], string='29. Form IR8S')
    ...
    mbf = fields.Float(compute='_get_payroll_computational_data', string='12. MBF', type='float', multi="payroll_data_all")
    donation = fields.Float(compute='_get_payroll_computational_data', string='13. Donation', type='float', multi="payroll_data_all")
    CPF_designated_pension_provident_fund = fields.Float(compute='_get_payroll_computational_data', string='14. CPF/Designated Pension or Provident Fund', type='float', multi="payroll_data_all")
    indicator_for_CPF_contributions = fields.Selection(selection=[('Y','Obligatory'), 
                                                                  ('N','Not obligatory')], string='84. Indicator for CPF contributions in respect of overseas posting which is obligatory by contract of employment')
    CPF_capping_indicator = fields.Selection(selection=[('Y','Capping has been applied'), 
                                                        ('N','Capping has been not applied')], string='85. CPF capping indicator')
...
#    salary_total= fields.Integer(compute='_get_payroll_computational_data', string='16. Gross Salary, Fees, Leave Pay, Wages and Overtime Pay ', type='integer', multi="payroll_data_all")
    ...
    employee_income = fields.Float("22. Fixed Amount of income tax liability for which tax borne by employee")
