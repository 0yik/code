odoo.define("hr_timesheet_summary.leave_employee", function (require) {
    "use strict";
    ...
    var timesheet = require('hr_timesheet_invoice');
...
//    console.log('ssssss',core.form_custom_registry)
//    var CustomerWeeklyTimesheet = timesheet.WeeklyTimesheet.extend({
//            init: function() {
            ...
            _.each(self.accounts, function(account) {
                ...
                _.each(_.range(account.days.length), function(day_count) {
                    if (!self.get('effective_readonly')) {
                        ...
                        var abc = self.get_box(account, day_count).html(self.sum_box(account, day_count, true));
                        var sheetdate = account.days[counter].day;
                        var sheetdate = account.days[counter].day;
                        ajax.jsonRpc('/hr/sheet/leave/data', 'call', {
                            'data': sheetdate,
