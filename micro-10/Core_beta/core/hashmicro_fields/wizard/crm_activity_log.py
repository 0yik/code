...
class ActivityLog(models.TransientModel):
    ...
    _name = "crm.reseller.activity.log"
    ...
    def _default_lead_id(self):
        ...
        if self._context.get('active_model') == 'crm.reseller':
    ...
    lead_id = fields.Many2one('crm.reseller', 'Lead', required=True, default=_default_lead_id)
