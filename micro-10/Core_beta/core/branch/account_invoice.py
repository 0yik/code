    ...
    def action_move_create(self):
        ...
        for inv in self:
           ...
           # Pass invoice in context in method post: used if you want to get the same
            ...
            moduel_search = self.env['ir.module.module'].search([('name', '=', 'unposted_journal_config')]).state
            if moduel_search and 'installed' in moduel_search:
                print 'Installed'
                if inv.type == 'out_invoice' and self.env['ir.config_parameter'].get_param('unposted_journal_config.customer_invoice_unpost') == False:
                    move.post()
                if inv.type == 'in_invoice' and self.env['ir.config_parameter'].get_param('unposted_journal_config.vendor_bill_unpost') == False:
                    move.post()
            else:
                move.post()
