odoo.define('hr_organization_chart.org_chart_button', function(require) {
    "use strict";
    ...
    var OrgChartButton = form_widget.WidgetButton.include({
        ...
        on_click: function() {
            ...
            try{
                ...
                $("button.o_form_button_edit").prop('disabled', false);
                $("button.o_form_button_edit").css('color', '');
                $("button.o_form_button_create").prop('disabled', false);
                $("button.o_form_button_create").css('color', '');
            }
            ...
            this.check_disable();
            $("button.oe_stat_button").prop('disabled', false);
            this.$el.css('color', '');
        },
