...

{
    ...
    "version": "1.3",
    "depends": ["base", "hr_payroll", "sg_holiday_extended","hr_timesheet_sheet", "l10n_sg", 'sg_hr_employee'],
...
============================
    ...
    * Medical Allowance, Travel Allowance, Child Allowance, ...
    ...
    'data': [
        ...
        'security/employee.country.csv',
        'security/employee.nationality.csv',
        'data/hr_employee_category_data.xml',
        'data/hr_emp_race.xml',
