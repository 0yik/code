...
class account_analytic_distribution_line(models.Model):
    ...
    request_line_id = fields.Many2one('purchase.request.line', 'Purchase Request Line', invisible=True)
    requisition_line_id = fields.Many2one('purchase.requisition.line', 'Purchase Requisition Line', invisible=True)
